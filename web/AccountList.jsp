<%-- 
    ...
    Created on : Oct 11, 2023, 2:23:04 AM
    Author     : mjnh
--%>
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>Account list</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
                                    ...
                                    <c:forEach items="${requestScope.list}" var="item">
                                        <tr>
                                            ...
                                            <td class="table-td-center"><button class="btn btn-primary btn-sm trash" type="button" title="Xóa" >
                                                    <a href="${pageContext.request.contextPath}/deleteUser?id=${item.id}"><i class="fas fa-trash-alt"></i></a>                                                
                                                </button>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input name="ID" class="form-control" type="text" value="${item.id}" readonly>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label class="control-label">Họ và tên</label>
                                                                <input class="form-control" name="fullname" type="text" required value="${item.fullname}">
                                                            </div>
                                                            <div class="form-group  col-md-6">
                                                                <label class="control-label">Tên đăng nhập</label>
                                                                <input class="form-control" type="text" name="username" required value="${item.username}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <input name="dob" class="form-control" type="date" value="${item.dob}">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <select name="role">
                                                                    <c:forEach items="${requestScope.roles}" var="i">
                                                                        <option value="${i.id}" ${i.id == item.role.id? 'selected' : ''}>${i.name}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
                                                        </div>
